      ...
      <div className="row">
        {aboutUs.map((about) => (
          <div className="col-sm-12 col-md-6 col-sm-6" key={about.id}>
            ...
            <p className="text-white">{about.about}</p>
          </div>
        ))}
      </div>
      <div className="mt-4">
        ...
        <div className="mt-3">
          <p className="text-white">Central Registration Depository: 166124</p>
          <p className="text-white">
            U.S. Securities and Exchange Commission: 801-106722
          </p>
          <p className="text-white">Registration Type: Initial Registration</p>
          <p className="text-white">Legal Name: Windrock Wealth Management</p>
          <p className="text-white">Alternative Name: Cryptox Advisory</p>
          <p className="text-white">DBA Name:</p>
        </div>
      </div>
    </div>
  );
